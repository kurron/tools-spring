 ...
 * gateways, such as REST endpoints or the database. This category signals an integration test
 * requiring access to an external system requiring a special environment to access, such as being
 * on the corporate network.  In terms of Spring, these type of tests normally
 ...
 */
public interface ExternalServiceOutboundIntegrationTest {
}
